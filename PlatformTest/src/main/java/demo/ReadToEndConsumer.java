...
public class ReadToEndConsumer {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String groupId = envOrDefault("KAFKA_GROUP", "read-to-end-consumer-platform-test");
        ...
        //same amount as max in flight
        int workers = Integer.parseInt(envOrDefault("WORKERS", "1200"));
        int queueSize = Integer.parseInt(envOrDefault("QUEUE", "2000"));
        ...
        try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(props)) {
            ...
            while (true) {
                ...
                if (!records.isEmpty()) {
                    ...
                    // Commit after processing completes (at-least-once-ish)
            ...
            workerPool.shutdown();
            // For benchmarking, don't sleep forever; let it exit cleanly.
            try {
    ...
    private static void doWork(ConsumerRecord<String, String> r) {
        // Replace this with your actual work for benchmarking.
